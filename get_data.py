...
while True:
    ...
    for i in range(0, detections.shape[2]):
        ...
        try:
            ...
            if(area < 307200):
                ...
                cv2.putText(frame,str(round(confidence, 4)),(startX,startY), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2,(0,0,255),2,cv2.LINE_AA)
        except:
            pass
    ...
    if key == ord("p"):
        try:
            cv2.imwrite("./data/" + str(userid) + "/" + str(counter) + ".jpg", faces[0])
            counter += 1
        except:
            pass
